import os
import re
from commands.Commands import create_file, delete_file, copy
...
***************************************************************************************************************'''
def analizador_lexico(linea_comando, _type_storage = True):
    global type_storage
    ...
    if(instruccion_comando=="create"):
        ...
        if(paso_from and paso_to and paso_mode):
            if(type_storage):
                ...
                mensaje_salida=metodo_transfer_nube(from_valor,to_valor,mode_valor)
            agregar_a_bitacora(mensaje_salida)
        else:
...
def agregar_a_bitacora(linea_bitacora):
    ...
    linea_bitacora=today+linea_bitacora
